...
endpoints: it loads `/gui`, clicks Generate, and checks that the quadrant
actually renders, the export buttons appear, and no JavaScript error fires.
...
def test_generate_flow_renders(base_url: str) -> None:
